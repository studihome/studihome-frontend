(() => {
  ...
  function renderArticleDetail(article, products) {
    ...
    return `
      <div class="w-full md:max-w-4xl mx-auto md:my-8">
        <!-- Back button -->
        ...
        <article class="w-full bg-white md:max-w-4xl mx-auto md:my-8 md:rounded-2xl rounded-none px-5 py-8 md:px-12 md:py-12 shadow-none md:shadow-md mb-6 md:mb-0">
          <div>
            <!-- Category (semantic) -->
            ...
            <!-- Tags + Share (inline) -->
            <div class="flex flex-wrap items-center justify-between gap-6 mt-12 pt-6 border-t border-slate-100">
              <!-- Left: tags -->
