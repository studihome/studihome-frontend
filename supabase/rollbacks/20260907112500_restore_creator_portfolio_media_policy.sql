-- Exact rollback for 20260907112500_reconcile_creator_portfolio_media_policy.sql
-- Restores the four audited legacy constraints and their VALID / NOT VALID states.
...
alter table public.creator_portfolios
  ...
  check (lower(coalesce(media_type,'')) = any(array['image','youtube','drive','tiktok','instagram','video','link']))
  not valid;
